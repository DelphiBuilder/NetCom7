...
begin
  ...
  begin
    ...
    ConnectionSuccess := TncLineInternal(Line).CreateClientHandle(FHost, FPort);

    // Only set as connected if the connection actually succeeded
    if not ConnectionSuccess then
    begin
      WasConnected := False;
      // Make sure the line is marked as inactive on connection failure
      if Line.Active then
            ...
            try
              ...
              begin
                ...
                try
                  ...
                  // Only mark as reconnected if the connection actually succeeded
                  WasReconnected := FClientSocket.Active;
                finally
